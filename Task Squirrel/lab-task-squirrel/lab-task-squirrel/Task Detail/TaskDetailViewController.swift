...
class TaskDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        mapView.register(TaskAnnotationView.self, forAnnotationViewWithReuseIdentifier: TaskAnnotationView.identifier) // .register() makes mapView aware of our custom class
    ...
    @IBAction func didTapAttachPhotoButton(_ sender: Any) {
        ...
        // after creating if-else, need to update Info.plist with NSPhotoLibraryUsageDescription and give a description for why data-access is needed
        //photo picker wont work without this
        //MARK: THIS ENDS STEP 1.
        
    } //end didTapAttachPhotoButton()

    private func presentImagePicker() {
        // TODO: Create, configure and present image picker.
        // MARK: START OF STEP 2
    ...
    func updateMapView() {
        ...
        let region = MKCoordinateRegion(center: coordinate, span: MKCoordinateSpan(latitudeDelta: 0.01, longitudeDelta: 0.01)) //can adjust amount of zoom on map by chaning span values
...
extension TaskDetailViewController: PHPickerViewControllerDelegate {
    ...
    } //MARK: Adding this func is END OF STEP 2
    
} // ensures that the TaskDetailViewController conforms to the PHPickerViewControllerDelegate
...
}   //MARK: STEP 7 relevant func
    // ensures that the TaskDetailViewController conforms to the MKMapViewDelegate
